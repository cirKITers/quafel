...
fig, ax = plt.subplots()
im, cbar = plot_util.heatmap(duration_matrix, shots_list, [d for d in range(evals//10)], ax=ax,
                   cmap="magma_r", cbarlabel=f"n circuit duration [s] - {depth} depth, {qubits} qubits")
